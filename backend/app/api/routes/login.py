...
def recover_password(email: str, db: SessionDep) -> Message:
    """
    Password Recovery
    """
...
def reset_password(db: SessionDep, body: NewPassword) -> Message:
    """
    Reset password
    """
...
def recover_password_html_content(email: str, db: SessionDep) -> Any:
    """
